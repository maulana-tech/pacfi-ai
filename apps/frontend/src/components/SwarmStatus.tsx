    ...
    <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
      ...
      >
        <div>
          ...
          {lastRun && (
            <p style={{ fontSize: 11, color: '#9CA3AF', marginTop: 2 }}>Last cycle: {lastRun}</p>
          )}
        </div>
        <button onClick={runCycle} disabled={isRunning} className="btn btn-primary btn-sm">
          {isRunning ? (
            <>
              <svg
                width="11"
              ...
              >
                ...
                <path
                  d="M5.5 1 A4.5 4.5 0 0 1 10 5.5"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                />
